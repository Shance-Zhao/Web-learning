...
<c:set var="contextPath" value="${pageContext.request.contextPath}" />
		...
		<table class="table">
            ...
            <tr>
            <form method='post' action='${contextPath}/product/deletesuccess'>
            	<td><input class="btn-danger" name="delete"type="submit" value="Delete"></td>
                <td><input name="proID" type="hidden" value="${pro.productID}" /></td>
                <td>${pro.name}</td>
