	...
	<div class="container-fluid">
		...
		<div class="col-sm-9 col-md-10 main">
            ...
            <tr>
 			...
 			<c:forEach var="pro" items="${searchgeneral}">
             <tr>
                 <td style="text-align: center">${pro.name}</td>
                 <td style="text-align: center"><img src="${pro.filename}" width='150' height='170'></td>
                 <td style="text-align: center">${pro.saleprice}</td>
